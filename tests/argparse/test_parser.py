...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            dt.datetime,
            ...,
            "--test 2021-12-25T12:34",
            dt.datetime(2021, 12, 25, 12, 34),
        ),
        ...
        (
            dt.datetime,
            dt.datetime(2021, 7, 21, 3),
            "--test 2021-04-03T02:00",
            dt.datetime(2021, 4, 3, 2),
        ),
        ...
        (
            Optional[conf.TestEnumSingle],
            conf.TestEnumSingle.D,
            "",
            conf.TestEnumSingle.D,
        ),
        # Commands
        ...
        (
            ...
            ...,
            "test cmd_01",
            conf.TestCommands(cmd_01=conf.TestCommand()),
        ),
        (
            conf.TestCommands,
            ...,
            "test cmd_02",
            conf.TestCommands(cmd_02=conf.TestCommand()),
        ),
        (
            conf.TestCommands,
            ...,
            "test cmd_03",
            conf.TestCommands(cmd_03=conf.TestCommand()),
        ),
        (
            conf.TestCommands,
            ...,
            "test cmd_01 --flag",
            conf.TestCommands(cmd_01=conf.TestCommand(flag=True)),
        ),
        (
            conf.TestCommands,
            ...,
            "test cmd_02 --flag",
            conf.TestCommands(cmd_02=conf.TestCommand(flag=True)),
        ),
        (
            conf.TestCommands,
            ...,
            "test cmd_03 --flag",
            conf.TestCommands(cmd_03=conf.TestCommand(flag=True)),
        ),
        (Optional[conf.TestCommand], ..., "test", conf.TestCommand()),
        (
            Optional[conf.TestCommands],
            ...,
            "test cmd_01",
            conf.TestCommands(cmd_01=conf.TestCommand()),
        ),
