...
@pytest.fixture
def model() -> type[pydantic.BaseModel]:
    """Creates pydantic model for testing.

    Returns:
        type[pydantic.BaseModel]: Pydantic model for testing.
    """
    # Create Model for ArgumentParser
    class Model(pydantic.BaseModel):
        ...
        arg_19: int                  = pydantic.Field(12345,                         description="arg_01")
